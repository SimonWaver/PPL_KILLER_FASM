...
3. Второй вызов ZwQuerySystemInformation с уже выделенным буфером, функция заполняет его реальными данными, сязным списком структур SYSTEM_PROCESS_INFORMATION, по одной на каждый процесс
